...
enum message_target_type
{
    ...
    MSG_TARGET_PORT=0x02,
    MSG_TARGET_NAME=0x04,
    MSG_TARGET_UUID=0x08,
    MSG_TARGET_RECORD=0x10,
    MSG_TARGET_EXPAND=0x20,
    MSG_TARGET_SPLIT=0x40,
    MSG_TARGET_CONN=0x80,
    MSG_TARGET_MIXUUID=0x100,
